...
class UpdateRequest extends FormRequest
{
    ...
    /**
     * ルール:
     * - type が single_choice / multi_choice かつ max_select(=n) > 0 のとき、
     *   先頭 n 件の options[i][label] を required にする
     * - n 件未満しか送られてこない場合に備えて、options に min:n も課す
     */
